...
const NotesSection: React.FC<NotesSectionProps> = ({
  ...
  return (
    <>
      <div
        className="shadow-lg border overflow-hidden h-full flex flex-col rounded-2xl"
        style={{
          background: darkBg,
      ...
      >
        ...
        <div className="px-4 pt-3 flex gap-2">
          <button
            ...
            className="flex-1 text-xs font-semibold py-1.5 transition-all rounded-lg"
            style={
              noteType === 'general'
        ...
        <div className="px-4 pt-3">
          <div className="flex gap-2">
            <textarea
              ...
              rows={2}
              className="flex-1 px-3 py-2 border text-sm focus:outline-none focus:ring-2 transition-all resize-none rounded-xl"
              style={{
                borderColor: darkBorder,
                color: darkInputText,
            ...
            <motion.button
              ...
              className="self-end p-2.5 transition-all rounded-xl"
              style={
                noteText.trim()
                  ? { backgroundColor: theme.accentColor, color: 'white' }
                  : {
        ...
        <div className="flex-1 p-4 overflow-y-auto space-y-2 custom-scrollbar">
          {sortedNotes.length === 0 ? (
            <div
              ...
              style={{ color: isDark ? '#4B5563' : theme.emptyColor }}
            >
              ...
              {sortedNotes.map((note, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group p-3 shadow-sm hover:shadow-md transition-shadow rounded-xl"
                    style={{
                      borderWidth: 1,
                      borderColor: darkBorder,
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <motion.button
                        ...
                        className="p-1 opacity-0 group-hover:opacity-100 transition-all flex-shrink-0 rounded-lg"
                        whileHover={{
                          scale: 1.1,
                    ...
                    <div className="flex flex-col gap-1 mt-2">
                      <span
                        className="text-[10px] px-1.5 py-0.5 font-semibold inline-block w-fit rounded-md"
                        style={
                          isGeneral
                            ? {
